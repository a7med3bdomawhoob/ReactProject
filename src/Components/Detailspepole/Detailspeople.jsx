...
import styles from './Detailspeople.module.css'
// import styles from './Detailstv.module.css'
export default function Detailstv() {
    ...
    useEffect(() => {
        getdetails('person', idfromsearchparam);
                ...
                <div className="row">
                    <div className="col-md-4 ">
                        <div className="film mt-5 ms-5">
                            <img className=' w-100' src={firstPartOfUrl + details.profile_path} alt="" />
                        </div>
                    </div>
